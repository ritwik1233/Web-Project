...
try{
result1=stmt1.executeQuery("SELECT ID FROM USERS WHERE POWER=3");
...
<li><input type="button" class="btns" value="Search by Date"  onclick="openPage('extractorSearch.jsp')"></li>
</ul>
</div>
</div>
...
<ul>
<li>
<input type="button" class="btns" value="Pending with Extractor" onclick="openPage('extractorPending.jsp')" />
</li>
<li><input type="button" class="btns" value="Completed Data Request"  onclick="openPage('extractorComplete.jsp')"/></li>
</ul>
</div>
</div>
...
<div class="admin">
<h2 align="center" style="color:blue"><i>Extractor (<%= session.getAttribute("userName").toString() %>) : Welcome to e-Data Request of Analytics </i></h2>
</div>
<br/>
<div align="center">
<%
...
{
%>
<tr><td>No of Requests Assigned to Extractor</td><td><%= result.getString(3) %></td></tr>
