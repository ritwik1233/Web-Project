...
try{
result=stmt.executeQuery("SELECT DISTINCT FILEID ,TOPIC ,b.NAME ,c.NAME ,DESCRIPTION, EXT ,CASE WHEN STATUS=0 THEN 'Pending' WHEN STATUS=1 THEN 'Raised' WHEN STATUS=2 THEN 'Assigned' ELSE 'Complete' END, GEN_DT, STRT_DT,d.NAME FROM REQUESTS a, USERS_A b, USERS_L c, USERS_E d WHERE a.ANALYST=b.ID AND a.LEADER=c.ID AND a.EXTRACTOR=d.ID AND STATUS=2 AND TRIM(ANALYST)=TRIM('"+id+"') ORDER BY FILEID");
